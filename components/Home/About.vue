<template>
    <section class="home-about section-m-top section-white">
        <div class="container">
            <div class="home-about__first-content">
                <h2 class="heading-2">
                    Who we are
                </h2>
                <p class="body-copy">
            ...
            <div class="home-about__dots-container">
                <div class="home-about__dots">
                    <img src="@/assets/images/home-about-dots.svg" class="u-image-contain">
                </div>
                <div class="home-about__first-image">
                    <img src="@/assets/images/home-about.jpg" alt="In Your Shoes Consulting" class="u-image-cover">
                </div>
                <div class="home-about__dots">
                    <img src="@/assets/images/home-about-dots.svg" class="u-image-contain">
                </div>
            </div>
            <div class="home-about__arrow">
                <img src="@/assets/images/home-about-arrow.svg" class="u-image-contain">
            </div>
            <h2 class="heading-2 home-about__shoes-title">
